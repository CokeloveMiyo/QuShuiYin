...
# 业务常量
_raw_domain_map = business_config["DOMAIN_TO_NAME"]
DOMAIN_TO_NAME = {}
for _domain, _name in _raw_domain_map.items():
    _d = _domain.lower()
    DOMAIN_TO_NAME[_d] = _name
    if _d.startswith('www.'):
        DOMAIN_TO_NAME[_d[4:]] = _name
    else:
        DOMAIN_TO_NAME[f'www.{_d}'] = _name
